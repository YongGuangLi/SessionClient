...
class TSStatus : public virtual ::apache::thrift::TBase {
 public:
  ...
  void __set_redirectNode(const EndPoint& val);
...
typedef struct _TSExecuteStatementReq__isset {
  _TSExecuteStatementReq__isset() : fetchSize(false), timeout(false), enableRedirectQuery(false) {}
  bool fetchSize :1;
  bool timeout :1;
...
class TSExecuteStatementReq : public virtual ::apache::thrift::TBase {
 public:
  ...
  TSExecuteStatementReq() : sessionId(0), statement(), statementId(0), fetchSize(0), timeout(0), enableRedirectQuery(0) {
  }
...
class TSInsertRecordReq : public virtual ::apache::thrift::TBase {
 public:
  ...
  TSInsertRecordReq() : sessionId(0), deviceId(), values(), timestamp(0) {
  }
...
class TSInsertStringRecordReq : public virtual ::apache::thrift::TBase {
 public:
  ...
  TSInsertStringRecordReq() : sessionId(0), deviceId(), timestamp(0) {
  }
...
class TSInsertRecordsOfOneDeviceReq : public virtual ::apache::thrift::TBase {
 public:
  ...
  TSInsertRecordsOfOneDeviceReq() : sessionId(0), deviceId() {
  }
...
class TSInsertStringRecordsReq : public virtual ::apache::thrift::TBase {
 public:
  ...
  TSInsertStringRecordsReq() : sessionId(0) {
  }
...
typedef struct _TSRawDataQueryReq__isset {
  _TSRawDataQueryReq__isset() : fetchSize(false), enableRedirectQuery(false) {}
  bool fetchSize :1;
  bool enableRedirectQuery :1;
...
class TSRawDataQueryReq : public virtual ::apache::thrift::TBase {
 public:
  ...
  TSRawDataQueryReq() : sessionId(0), fetchSize(0), startTime(0), endTime(0), statementId(0), enableRedirectQuery(0) {
  }
